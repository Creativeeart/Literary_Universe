...
public class UIManager : MonoBehaviour {
    ...
    void UpdateResUI(ResolutionScreenType type, int score)
    {
        ...
        switch (type)
        {
            case ResolutionScreenType.Correct:
                ...
                uIElements.ResolutionStateInfoText.text = "ПРАВИЛЬНО!";
                uIElements.ResolutionScoreText.text = "+" + score;
                break;
            case ResolutionScreenType.Incorrect:
                uIElements.ResolutionBG.color = parameters.IncorrectBGColor;
                uIElements.ResolutionStateInfoText.text = "НЕПРАВИЛЬНО!";
                uIElements.ResolutionScoreText.text = "-" + score;
                break;
            case ResolutionScreenType.Finish:
                uIElements.ResolutionBG.color = parameters.FinalBGColor;
                uIElements.ResolutionStateInfoText.text = "НАБРАНО ОЧКОВ";

                StartCoroutine(CalculateScore());
                uIElements.FinishUIElements.gameObject.SetActive(true);
                uIElements.HighScoreText.gameObject.SetActive(true);
                uIElements.HighScoreText.text = ((highscore > events.StartupHighscore) ? "<color=yellow>new </color>" : string.Empty) + "ЛУЧШИЙ РЕЗУЛЬТАТ: " + highscore;
                break;
        }
    }
    ...
    void UpdateScoreUI()
    {
        uIElements.ScoreText.text = "Очки: " + events.CurrentFinalScore;
    }
}