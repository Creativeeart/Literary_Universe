...
public class AudioManagerQuiz : MonoBehaviour {

    #region Variables

    public static       AudioManagerQuiz    Instance        = null;

    [SerializeField]    SoundQuiz[]         sounds          = null;
    ...
    SoundQuiz GetSound(string name)
    {
        foreach (var sound in sounds)
        {
            if (sound.Name == name)
