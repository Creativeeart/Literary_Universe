    ...
    public class Game_05_Controller : MonoBehaviour
    {
        ...
        IEnumerator OpenedColors()
        {
            ...
            for (int i = 0; i < randomMaterials.Length; i++)
            {
                ...
                _audioSource.pitch = 1.2f;
                _audioSource.PlayOneShot(lampPickSound);
                if ((mainBulbs[i].GetComponent<MeshRenderer>().material.name != computerBulbs[i].GetComponent<MeshRenderer>().material.name)
                    && (mainBulbs[i].GetComponent<MeshRenderer>().material.name == playerBulbs[i].GetComponent<MeshRenderer>().material.name))
                {
                ...
                else if ((mainBulbs[i].GetComponent<MeshRenderer>().material.name != playerBulbs[i].GetComponent<MeshRenderer>().material.name)
                    && (mainBulbs[i].GetComponent<MeshRenderer>().material.name == computerBulbs[i].GetComponent<MeshRenderer>().material.name))
                {
        ...
        public void GameOver()
        {
            ...
            _fortBoyardGameController.LoseRoom("Мастер победил!\nК сожалению вы не справились с испытанием");
        }
        ...
        IEnumerator WinnerAnimations()
        {
            ...
            _fortBoyardGameController.WinnerRoom("Tips");
        }
        IEnumerator RestartGameCoroutine(bool isRestart)
        {
            ...
            for (int i = 0; i < playerTumblers.Length; i++)
            {
                ...
                playerTumblers[i].GetComponent<RotateTumbler>().fakeAngles = 0;
